...
//                    .header("custom_header", "pre_prod")
                ...
                .addInterceptor(ConnectivityInterceptor(com.renesistech.quotes.Application.applicationContext()))
                .build()
    }
    ...
    fun providePrefs(): PreferencesHelper {
        return PreferencesHelper(com.renesistech.quotes.Application.applicationContext())
    }
